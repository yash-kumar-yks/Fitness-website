      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-20">
          ...
          <div className="md:col-span-5">
            ...
            <p className="text-gray-500 dark:text-slate-400 text-lg leading-relaxed font-medium mb-8 max-w-sm">
            ...
            <div className="flex items-center space-x-4">
               <div className="flex flex-col">
                  <span className="text-[10px] font-black text-gray-400 dark:text-slate-500 uppercase tracking-widest">Questions?</span>
                  <a href="mailto:hello@fitbitez.in" className="text-emerald-600 dark:text-emerald-400 font-black text-lg hover:underline transition-all">hello@fitbitez.in</a>
               </div>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            <h4 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-[0.3em] mb-8">Navigation</h4>
            <ul className="space-y-4">
              <li><a href="#hero" className="text-gray-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 font-bold transition-colors">Overview</a></li>
              <li><a href="#about" className="text-gray-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 font-bold transition-colors">About</a></li>
              <li><a href="#features" className="text-gray-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 font-bold transition-colors">Features</a></li>
              <li><a href="#activity" className="text-gray-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 font-bold transition-colors">My Logs</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-gray-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 font-bold transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="text-gray-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 font-bold transition-colors">Terms of Use</a></li>
              <li><a href="#" className="text-gray-500 dark:text-slate-400 hover:text-emerald-600 dark:hover:text-emerald-400 font-bold transition-colors">Cookie Data</a></li>
            </ul>
          </div>

          {/* Social Column */}
          <div className="md:col-span-3">
             <h4 className="text-xs font-black text-gray-900 dark:text-white uppercase tracking-[0.3em] mb-8">Connect</h4>
             <div className="flex space-x-6">
                <a href="#" className="w-12 h-12 bg-gray-50 dark:bg-slate-900 rounded-2xl flex items-center justify-center text-gray-400 dark:text-slate-500 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 hover:text-emerald-600 dark:hover:text-emerald-400 transition-all group shadow-sm border border-transparent dark:border-slate-800">
        ...
        <div className="border-t border-gray-100 dark:border-slate-800 pt-12">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
            ...
            <div className="flex flex-col text-right">
              <p className="text-gray-900 dark:text-white font-black text-sm mb-1 uppercase tracking-tighter">© 2024 FitBitez.in</p>
